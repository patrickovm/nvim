...
hi(
    "StatusMode",
    { guibg = palette.green, guifg = palette.background, gui = "bold" }
)
...
hi(
    "StatusGit",
    { guibg = palette.current_line, guifg = palette.foreground, gui = "bold" }
)
...
hi("StatusWarnIcon", { guibg = NONE, guifg = palette.orange, gui = "bold" })
hi("StatusInfoIcon", { guibg = NONE, guifg = palette.cyan, gui = "bold" })
hi("StatusHintIcon", { guibg = NONE, guifg = palette.green })

hi("StatusBuffer", { guibg = palette.current_line, guifg = palette.foreground })
hi("StatusType", { guibg = palette.current_line, guifg = palette.foreground })
hi("StatusNorm", { guibg = NONE, guifg = NONE })
hi("StatusLocation", { guibg = palette.comment, guifg = palette.foreground })
hi(
    "StatusPercent",
    { guibg = palette.purple, guifg = palette.background, gui = "bold" }
)
